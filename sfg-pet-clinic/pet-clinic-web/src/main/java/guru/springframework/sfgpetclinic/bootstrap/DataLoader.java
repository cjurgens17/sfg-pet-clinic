...
public class DataLoader implements CommandLineRunner {
    ...
    public DataLoader(OwnerService ownerService, VetService vetService, PetTypeService petTypeService, SpecialitiesService specialitiesService, VisitService visitService, PetService petService) {
    ...
    private void loadData() {
        ...
        catVisit.setPet(mickeysCat);
        catVisit.setDate(LocalDate.now());
        catVisit.setDescription("Sneezy Mickey");
